...
List<Vector3Int> miniFurtherTempMovesCurrentlylAvailable = new List<Vector3Int>();
List<Piece> furtherTempPieces = new List<Piece>();
List<Vector3Int> furtherTempPieceCoords = new List<Vector3Int>();
miniFurtherTempMovesCurrentlylAvailable.Add(furtherPositions.ElementAt(a).Item2);
furtherTempMovesCurrentlyAvailable.Add(miniFurtherTempMovesCurrentlylAvailable);
...
miniFurtherTempMovesCurrentlylAvailable.Clear();
furtherTempMovesCurrentlyAvailable.Clear();
furtherTempPieces.Clear();
furtherTempPieceCoords.Clear();
miniFurtherTempMovesCurrentlylAvailable.Add(halfWayMoveChosen.Item2);
furtherTempMovesCurrentlyAvailable.Add(miniFurtherTempMovesCurrentlylAvailable);
furtherTempPieces.Add(board.GetPieceOnSquare(halfWayMoveChosen.Item1));
furtherTempPieceCoords.Add(halfWayMoveChosen.Item1);
furtherPositionsWithEval.Add(GetMoveMostValueFrom2LookAheadWithAccuracyAndReturnEval(furtherTem
pMovesCurrentlyAvailable, furtherTempPieces, furtherTempPieceCoords, 0.15f));
}
...
opposingPieces.ElementAt(k).avaliableMoves, board.GetPieceOnSquare(opposingPieceCoords.ElementAt(i))
